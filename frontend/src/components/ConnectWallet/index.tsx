...
export const ConnectWallet: FC<Props> = ({inline}) => {
  ...
  return (
    <>
      ...
      {isConnected && account && <ConnectedAccount
          className={StringUtils.clsx(classes.connectedAccount, inline ? classes.connectedAccountInline : undefined)}
          address={account} chainName={chainName!}/>}
    </>
  )
}
